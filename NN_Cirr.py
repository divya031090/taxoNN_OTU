...
otuinfile = 'Cirr_OTU.csv'
metadata = 'Cirr_metadata.txt'
# Split 70% of data as training and 30% as test
train_ratio = 0.7
metavar = ['disease_stat','disease_status']  
levels = ['Positive','Negative']
# Read data
data = Cirr_input.data_metadata_Cirr(otuinfile,metadata,train_ratio,metavar,levels)
...
acc_ens=ensembling_Cirr.ensemble(trainX, testX, trainy, testy,n_members)
