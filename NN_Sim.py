...
# Read data
data = Sim_input.data_metadata_Sim(otuinfile,metadata,train_ratio,metavar,levels)
...
acc_ens=ensembling_Sim.ensemble(trainX, testX, trainy, testy,n_members)
